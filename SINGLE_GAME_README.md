...
- `games/libpxt.so` — shared PXT VM library for this architecture.
- `games/<Name>` — native Game executable (renamed from the `Game` file in the tar.gz).
